...
| **Chat & Completion** | OpenAI-compatible chat with <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> models |
...
The Go SDK for the whole BlockRun API — <!-- br:models.chatVisible -->79<!-- /br:models.chatVisible --> chat models, image, video, music, speech, voice calls, multi-chain RPC, web search, market data, prediction markets, DeFi and DEX data. Pay with an API key and prepaid credit, or with x402 micropayments from your own wallet. No subscriptions either way. The `-llm-` in the name is history, not scope.
